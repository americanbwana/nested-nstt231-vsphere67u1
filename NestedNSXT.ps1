# Author: Dana Gertsch (@knotacoder)
# Added NSX 2.3.1 & 6.7U1 components
...
# Reference: http://www.virtuallyghetto.com/2017/10/vghetto-automated-nsx-t-2-0-lab-deployment.html# Modified by Dana Gertsch

# vCenter Server used to deploy Lab
$VIServer = "vc.corp.local"
$VIUsername = "administrator@vsphere.local"
$VIPassword = "VMware1!"

# Full Path to both the Nested ESXi 6.7u1 VA, VCSA 6.7u1 ISO & NSX-T OVAs
$NestedESXiApplianceOVA = "e:\Software\vSphere 6.7\Nested_ESXi6.7u1_Appliance_Template_v1.ova"
$VCSAInstallerPath = "f:\" # using VirtualClone Drive
$NSXTManagerOVA = "e:\Software\NSX-T\nsx-unified-appliance-2.3.1.0.0.11294305.ova"
$NSXTControllerOVA = "e:\Software\NSX-T\2.3.1\nsx-controller-2.3.1.0.0.11294300.ova"
$NSXTEdgeOVA = "e:\Software\NSX-T\2.3.1\nsx-edge-2.3.1.0.0.11294325.ova"

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
"vesxi67-1" = "10.44.18.151"
"vesxi67-2" = "10.44.18.152"
"vesxi67-3" = "10.44.18.153"
}
...
$VCSADisplayName = "nested-vc"
$VCSAIPAddress = "10.44.18.154"
$VCSAHostname = "10.44.18.154" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
$VCSASSODomainName = "vsphere.local"
$VCSASSOSiteName = "vsphere.local" # Don't change. Needs alpha.alpha
...
$VMNetwork = "vDsVlan628"
$VMDatastore = "hq-tintri1"
$VMNetmask = "255.255.255.0"
$VMGateway = "10.44.18.1"
$VMDNS = "10.44.17.100"
$VMNTP = "pool.ntp.org"
$VMPassword = "VMware1!"
$VMDomain = "corp.local"
$VMSyslog = "10.44.17.100"
...
$NewVCVSANClusterName = "Nested Lab"
...
$NSXPrivatePortgroup = "vDSNestedPrivate"
...
$NSXTMgrHostname = "10.44.18.155"
$NSXTMgrIPAddress = "10.44.18.155" # Use IP if DNS is not in dns

# NSX-T Controller Configurations
$NSXTCtrvCPU = "2"
$NSXTCtrvMEM = "6"
$NSXControllerSharedSecret = "VMware1!VMware1!"
$NSXTControllerHostnameToIPs = @{
"nsxt-ctr1" = "10.44.18.156"
"nsxt-ctr2" = "10.44.18.157"
"nsxt-ctr3" = "10.44.18.158"
}
...
$debug = $true
$verboseLogFile = "nsxt231-vghetto-lab-deployment.log"
$vSphereVersion = "6.7"
...
# from https://github.com/PowerShell/PowerShell/issues/7092
...
if($deployVCSA -eq 1) {
        ...
        $config.new_vcsa.sso.domain_name = $VCSASSOSiteName
...
if($postDeployNSXConfig -eq 1 -and $DeployNSX -eq 1) {
    ...
    if($runAddVC) {
        ...
        $VCThumbprint = Get-SHA256Thumbprint $VCURL
...
My-Logger "NSX-T 2.3.1 Lab Deployment Complete!"
